...
// AbstractAccount.java from Activity 9
...
public abstract class AbstractAccount {
    ...
    public void withdraw(double amount, String enteredPin) throws AccountException {
        ...
        if(!validatePin(enteredPin)){
        ...
        else if(!"ACTIVE".equalsIgnoreCase(this.status)){
            ...
            this.processDebit(amount);
        }
    }

    public void transfer(AbstractAccount targetAccount, double amount, String enteredPin) throws AccountException {
        if (targetAccount == null) {
            throw new BankingException("Destination account cannot be null");
        }
