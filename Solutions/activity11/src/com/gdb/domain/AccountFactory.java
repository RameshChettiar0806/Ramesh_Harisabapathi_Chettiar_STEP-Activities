...
public class AccountFactory {
    ...
    public static IAccount createAccount(String type, String accNum, String name, int age, double balance, String status, String pin) {
        ...
        switch(type.toUpperCase()){
            case "SAVINGS": 
                return (IAccount) new SavingsAccount(accNum, name, age, balance, status, pin, 1000.0, 4.0);

            case "CURRENT": 
                return (IAccount) new CurrentAccount(accNum, name, age, balance, status, pin, 25000.0);

            case "FIXED_DEPOSIT":
            case "FD":
                return (IAccount) new FixedDepositAccount(accNum, name, age, balance, status, pin, 12, 6.5);

            case "SALARY":
                return (IAccount) new SalaryAccount(accNum, name, age, balance, status, pin, "TechCorp");
